...
public class lineChart {
    ...
    boolean symbol; 
    public lineChart(double[][] x,String portfolio,String xLabel,String yLabel,String xAxisPos,String yAxisPos,String symbol,String title){
        this.x=x;
    ...
    public lineChart(double[][] x,double[][] y,String portfolio,String xLabel,String yLabel,String xAxisPos,String yAxisPos,String symbol,String title){
        this.x=x;
        this.y=y;
        this.portfolio=portfolio;
        this.xLabel=xLabel;
    ...
    public void show(double[][] x,double[][] y){
        ...
        for(int i=0;i<x[0].length;i++){
            ...
            for(int j=0;j<x.length;j++){
                seriex.getData().add(new XYChart.Data(y[i][j],x[i][j]));
            }
